...
void TIM_TimeBaseInit(TIM_TypeDef* TIMx, TIM_TimeBaseInitTypeDef* TIM_TimeBaseInitStruct)
{
  ...
  if(((*(uint32_t*)&TIMx) == TIM1_BASE) || ((*(uint32_t*)&TIMx) == TIM8_BASE)||
     ((*(uint32_t*)&TIMx) == TIM2_BASE) || ((*(uint32_t*)&TIMx) == TIM3_BASE)||
     ((*(uint32_t*)&TIMx) == TIM4_BASE) || ((*(uint32_t*)&TIMx) == TIM5_BASE)) 
  {
  ...
  if(((*(uint32_t*)&TIMx) != TIM6_BASE) && ((*(uint32_t*)&TIMx) != TIM7_BASE))
  {
...
/**
  * @brief  Configures the TIM2 and TIM5 Remapping input Capabilities.
  * @param TIMx: where x can be 2, 5 or 11 to select the TIM peripheral.
  * @param TIM_Remap: specifies the TIM input reampping source.
  *   This parameter can be one of the following values:
  * @arg TIM2_TIM8_TRGO: TIM2 ITR1 is connected to TIM8 Trigger output(default)
  * @arg TIM2_ETH_PTP: TIM2 ITR1 is connected to ETH PTP trogger output.
  * @arg TIM2_USBFS_SOF: TIM2 ITR1 is connected to USB FS SOF. 
  * @arg TIM2_USBHS_SOF: TIM2 ITR1 is connected to USB HS SOF. 
  * @arg TIM5_GPIO: TIM5 Channel 4 is connected to dedicated Timer pin(default)
  * @arg TIM5_LSI: TIM5 Channel 4 is connected to LSI clock.
  * @arg TIM5_LSE: TIM5 Channel 4 is connected to LSE clock.
  * @arg TIM5_RTC: TIM5 Channel 4 is connected to RTC Output event.
  * @arg TIM11_GPIO: TIM11 Channel 1 is connected to dedicated Timer pin(default) 
  * @arg TIM11_HSE: TIM11 Channel 1 is connected to HSE clock.   
  * @retval : None
  */
                       ...
                       uint16_t TIM_ICFilter)
{
  ...
  /* Select the Input and set the filter */
  tmpccmr1 &= (~TIM_CCMR1_CC2S) & (~TIM_CCMR1_IC2F);
                       ...
                       uint16_t TIM_ICFilter)
{
  ...
  /* Select the Input and set the filter */
  tmpccmr2 &= (~TIM_CCMR1_CC1S) & (~TIM_CCMR2_IC3F);
                       ...
                       uint16_t TIM_ICFilter)
{
  ...
  /* Select the Input and set the filter */
  tmpccmr2 &= (~TIM_CCMR1_CC2S) & (~TIM_CCMR1_IC2F);
