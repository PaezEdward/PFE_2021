...
/* ADC DISCNUM mask */
#define CR1_DISCNUM_RSEET         ((uint32_t)0xFFFF1FFF)

/* ADC AWDCH mask */
#define CR1_AWDCH_RSEET           ((uint32_t)0xFFFFFFE0)   

/* ADC Analog watchdog enable mode mask */
#define CR1_AWDMode_RSEET         ((uint32_t)0xFF3FFDFF)   

/* CR1 register Mask */
#define CR1_CLEAR_MASK            ((uint32_t)0xFCFFFEFF)

/* ADC EXTEN mask */
#define CR2_EXTEN_RSEET           ((uint32_t)0xCFFFFFFF)  

/* ADC JEXTEN mask */
#define CR2_JEXTEN_RSEET          ((uint32_t)0xFFCFFFFF)  

/* ADC JEXTSEL mask */
#define CR2_JEXTSEL_RSEET         ((uint32_t)0xFFF0FFFF)  
...
/* ADC L Mask */
#define SQR1_L_RSEET              ((uint32_t)0xFF0FFFFF) 
...
#define JSQR_JL_RSEET             ((uint32_t)0xFFCFFFFF) 
...
/**
  ...
  * @param  ADC_CommonInitStruct: pointer to an ADC_CommonInitTypeDef structure that
  *   contains the configuration information for  All ADCs peripherals.
  * @retval None
  */
void ADC_CommonInit(ADC_CommonInitTypeDef* ADC_CommonInitStruct)                           
{
  ...
  tmpreg1 |= (uint32_t)(ADC_CommonInitStruct->ADC_Mode | ADC_CommonInitStruct->ADC_Prescaler | 
                   ADC_CommonInitStruct->ADC_DMAAccessMode | ADC_CommonInitStruct->ADC_TwoSamplingDelay);
  /* Write to ADC CCR */
  ADC->CCR = tmpreg1;
}
...
/**
  * @brief  Enables or disables the ADC DMA request after last transfer (Multi-ADC mode) 
  * @param  ADCx: where x can be 1, 2 or 3 to select the ADC peripheral.
  * @param  NewState: new state of the selected ADC DMA request after last transfer
  *   This parameter can be: ENABLE or DISABLE.
  * @retval None
...
/**
  * @brief  Returns the last ADC1, ADC2 and ADC3 conversion results data in the selected multi mode.
  * @param  None  
  * @retval The Data conversion value.
  */
...
/**
  ...
  * @param  ADCx: where x can be 1, 2 or 3 to select the ADC peripheral.
  * @param  NewState: new state of the selected ADC discontinuous mode on injected group channel.
  *   This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
...
/**
  ...
  *   This parameter can be one of the following values:
  *     @arg ADC_ExternalTrigInjecConvEdge_None: external trigger disabled for injected conversion
  ...
  *     @arg ADC_ExternalTrigInjecConvEdge_RisingFalling: detection on both rising and falling edge
  * @retval None
  */
